...
String activation_password = "---";//change with your activation password
String deactivation_password = "---";//change with your deactivation password
void setup() {
...
SendMessage("Hey! it's the alarm. Type On to activate");
  RecieveMessage();
}
void loop() {
  String RSMS;
